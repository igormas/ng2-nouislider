...
describe('Nouislider Component', () => {
    ...
    describe('single slider', () => {
        ...
        it('should set config', () => {
            ...
            expect(JSON.parse(JSON.stringify(sliderInstance['options'])))
                .toEqual(JSON.parse(JSON.stringify(defaultOptions)));
            expect(JSON.parse(JSON.stringify(sliderInstance.slider.options)))
                .toEqual(JSON.parse(JSON.stringify(defaultOptions)));
        });

        it('should set default formatter', () => {
            expect(sliderInstance['options'].format instanceof DefaultFormatter).toBeTruthy();
